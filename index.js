...
let val = document.getElementById("type");
  ...
  var slid =[{
    img1:"https://cdn01.pharmeasy.in/dam/banner/banner/37176137470-POCK27.jpg",
   
  },
  {
    img1:"https://cdn01.pharmeasy.in/dam/banner/banner/2faeb574eaa-slipper.jpg",
   
  },
  {
    img1:"https://cdn01.pharmeasy.in/dam/banner/banner/51e34800f6d-HURRAY.jpg",
    img2:"",
    imgs1:"https://cdn01.pharmeasy.in/dam/banner/banner/51e34800f6d-HURRAY.jpg",
    imgs2:"",
  ...
  localStorage.setItem("slid",JSON.stringify(slid));
  function slider(){
    let slide = JSON.parse(localStorage.getItem("slid")) ;
   
    console.log("gbbb");
    console.log("slid :",slide);
    let val1 = document.getElementById("slids");
        slide.map((elem ) => {
