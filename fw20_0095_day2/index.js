...
//search bar import
 ...
 import {addproduct} from './append.js';


 document.getElementById("Launches").innerHTML=addproduct();
 document.getElementById("Deals").innerHTML=addproduct();
 

 import {additem} from './append.js';
 document.getElementById("type").innerHTML=additem();
 document.getElementById("Trending").innerHTML=additem();
