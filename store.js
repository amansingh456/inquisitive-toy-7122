...
document.querySelector(".container").innerHTML = "";
 ...
 //let added = localStorage.setItem("prodata",JSON.stringify(elem));
 let added = localStorage.setItem("prodata",JSON.stringify(arr))
 // console.log(data)
 //window.location.href="cart.html"
//  alert("New product added into your cart" )
Swal.fire(
    'Congratulations !',
    'Your Product is added into cart !',
    'success'
  )
 }
